...
public class JanelaServidor implements Runnable {
	...
	public void escreverConsole(String mensagem) {
		this.textoConsole.append(mensagem + "\n");
	}

	public void escreverMensagem(String mensagem) {
		this.textoMensagens.append(mensagem + "\n");
	}

	public void escreverUsuariosOnline(String mensagem) {
		this.textoUsuariosOnline.setText(mensagem.replace(";", "\n"));
	}
}
